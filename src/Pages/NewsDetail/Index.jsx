  ...
  return (
    <PageContainer title={article.title} description={article.resumo}>
      <Box sx={{ px: 1, pt: 8, maxWidth: 'lg', mx: 'auto' }}>
        ...
        <Typography variant="h3" fontWeight={400} color="primary.main" gutterBottom sx ={{fontSize:{xs:'2Rem', md:'3Rem'}}}>
           {article.title}
        </Typography>
        ...
        <Box
          ...
          src={article.image}
          alt={article.title}
          sx={{ width: '100%', height: '320px', mb: 1, borderRadius:3, objectFit:'cover' }}
        />
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2 }}>
          ...
          <Typography variant="caption" color="text.secondary">• {article.leituraMinutos} min leitura</Typography>
